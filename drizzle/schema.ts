import { pgTable, index, text, boolean, timestamp, unique, check, uuid, foreignKey, pgEnum } from "drizzle-orm/pg-core"
...
export const organizationMembers = pgTable("organization_members", {
	...
	index("idx_organization_members_org_id").using("btree", table.organizationId.asc().nullsLast().op("uuid_ops")),
